...
// Handles Shorts, Live, youtu.be, standard watch links, and non-YouTube passthroughs.
...
export default async function EpisodePage({ params }: Params) {
  ...
  return (
    <main className="bg-white text-black font-sans min-h-screen selection:bg-black selection:text-white antialiased pb-24">
      ...
      {/* Header */}
      <section className="max-w-4xl mx-auto px-6 mt-20 md:mt-32 mb-12">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-black tracking-tighter leading-[0.9] uppercase text-black">
          {episode.title}
        </h1>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 mb-20">
        {embedUrl ? (
          <div className="w-full aspect-video bg-black rounded-sm overflow-hidden border border-black/10 shadow-xl">
            <iframe
              src={embedUrl}
      ...
      <section className="max-w-5xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 border-t border-black/10 pt-16">
        ...
        {episode.guest_name && (
          <div className="lg:col-span-5 border-t lg:border-t-0 lg:border-l border-black/10 pt-12 lg:pt-0 lg:pl-12">
            ...
            {episode.guest_image && (
              <div className="w-full aspect-[4/5] relative bg-gray-100 rounded-sm overflow-hidden border border-black/10 grayscale hover:grayscale-0 transition-all duration-500 shadow-sm">
                <img
