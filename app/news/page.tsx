...
export default function BusinessNewsPage() {
  return (
    <div className="min-h-screen bg-white text-black py-16 px-6 sm:px-12 lg:px-24 font-sans">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="text-center mb-16 border-b-2 border-black pb-8">
          ...
          <p className="text-base md:text-lg font-medium max-w-3xl mx-auto uppercase tracking-wide">
            Curated financial news and corporate reporting from the definitive platforms across APAC and Western markets.
          </p>
        </div>

        {/* Main Grid Layout (Tightened up spacing) */}
